...
function ready(datapoints) {
  ...
  d3.select('#continent').on('stepin', function () {
    svg.selectAll('rect').attr('fill', function (d) {
  ...
  svg.append('text').text('higher GDP ⟶').attr('class', 'gdp-note-higher').attr('text-anchor', 'middle').attr('font-size', 12).attr('x', width * 0.75).attr('y', height + 15);
  svg.append('text').text('⟵ lower GDP').attr('class', 'gdp-note-lower').attr('text-anchor', 'middle').attr('font-size', 12).attr('x', width * 0.25).attr('y', height + 15);
  ...
  function render() {
    ...
    svg.select('.gdp-note-higher').attr('text-anchor', 'middle').attr('font-size', 10).attr('x', newWidth * 0.75).attr('y', newHeight + 15);
    svg.select('.gdp-note-lower').attr('text-anchor', 'middle').attr('font-size', 10).attr('x', newWidth * 0.25).attr('y', newHeight + 15);
...
},{"d3":"../node_modules/d3/index.js","./data/countries.csv":"data/countries.csv"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
